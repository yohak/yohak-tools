...
export function pxToVw(value: NumberOrString, addUnit: boolean = false): NumberOrString {
...
export function pxToVh(value: NumberOrString, addUnit: boolean = false): NumberOrString {
  const px: number = typeof value === "string" ? stripPx(value) : value;
